...
internal sealed class TenantMemberRoleAssignmentMap : IEntityTypeConfiguration<TenantMemberRoleAssignment>
{
    public void Configure(EntityTypeBuilder<TenantMemberRoleAssignment> builder)
    {
        ...
        builder.Property(assignment => assignment.TenantMembershipId).HasColumnName("tenant_membership_id").HasConversion(TsidValueConverter.Shared);
        builder.Property(assignment => assignment.TenantRoleId).HasColumnName("tenant_role_id").HasConversion(TsidValueConverter.Shared);
