...
function ForbiddenRoles() {
  return (
    <StatePanel
      ...
      title="دسترسی به نقش‌های این مستأجر مجاز نیست"
      description="حساب فعلی عضویت فعال یا مجوز لازم برای مشاهدهٔ نقش‌های این مستأجر را ندارد. سرور همین درخواست را بدون افشای داده رد کرده است."
    />
  )
}
...
function UnavailableRoles({ onRetry }: { onRetry: () => void }) {
  return (
    <StatePanel
      ...
      title="نقش‌ها در دسترس نیست"
      description="هم‌اکنون نمی‌توانیم نقش‌ها و مجوزها را بارگذاری کنیم."
      action={
