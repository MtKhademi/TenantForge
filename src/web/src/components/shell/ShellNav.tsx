 ...
 * from "فروشگاه" (Shop tenant destinations, all four existing catalog and
 * shipping/coupon admin links). S16 (F023) still governs scope-awareness
 * item-by-item inside each section; S12 (F019) still governs
 * `requires`-gating item-by-item. Grouping here changes neither — only how
 * the same items are laid out.
 */
